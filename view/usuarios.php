<div class="page-announce valign-wrapper"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">Usuarios</h1></div>
        ...
        <table class="responsive-table striped hover centered" id="names-table">
          ...
          <tbody>
            <tr>
              ...
              <td><a>Carlos</a></td>
              <td><a>Arceo Moo</a></td>
              <td><a>prueba@algo.com.mx</a></td>
              <td><a>México Oriente</a></td>
              <td>
                <div class="btn-toolbar">
                  <a href="#">
                    <button class="btn yellow tooltipped" type="submit"  data-position="bottom" data-delay="50" data-tooltip="Editar">
                    <i class="material-icons">border_color</i>      
                    </button>
                  </a>
                  <a href="#">
                    <button class="btn red tooltipped" type="submit" data-position="bottom" data-delar="50" data-tooltip="Eliminar">
    ...
    <div class="fixed-action-btn horizontal tooltipped" data-position="top" dattooltipped" data-position="top" data-delay="50" data-tooltip="Nuevo Usuario">
